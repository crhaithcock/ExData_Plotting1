...
# plot1 <- function(){
#     #opar <- par()
#     #plot(df.subset$Global_active_power,type = "h", main="Global Active Power", xlab="Global Active Power (kilowatts)")
#     hist(df.subset$Global_active_power,col="red", main="Global Active Power", xlab="Global Active Power (kilowatts)")
#     #par(opar)
#     }
# 
# plot2 <- function(){
#     plot(df.subset$Global_active_power, type = "l", main ="",ylab="Global Active Power (kilowatts)")
